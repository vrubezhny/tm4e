...
public class ThemeResolvingTest {
	...
	private static Theme createTheme(final ParsedThemeRule... rules) {
		return Theme.createFromParsedTheme(List.of(rules), null);
	}

	private static List<ParsedThemeRule> parseTheme(final String theme) throws Exception {
	...
	public void testStrcmpWorks() {
		final var actual = Arrays.asList("bar", "z", "zu", "a", "ab", "");
		actual.sort(CompareUtils::strcmp);

		final var expected = List.of("", "a", "ab", "bar", "z", "zu");
		assertArrayEquals(expected.toArray(), actual.toArray());
	}
	...
	public void testRespectsIncomingDefaults1() {
		final var actual = createTheme(new ParsedThemeRule("", null, -1, FontStyle.NotSet, null, null));
		final var colorMap = new ColorMap();
		final int _A = colorMap.getId("#000000");
		final int _B = colorMap.getId("#ffffff");
		final var expected = new Theme(colorMap,
	...
	public void testRespectsIncomingDefaults2() {
		final Theme actual = createTheme(new ParsedThemeRule("", null, -1, FontStyle.None, null, null));
		final var colorMap = new ColorMap();
		final int _A = colorMap.getId("#000000");
		final int _B = colorMap.getId("#ffffff");
	...
	public void testRespectsIncomingDefaults3() {
		final var actual = createTheme(new ParsedThemeRule("", null, -1, FontStyle.Bold, null, null));
		final var colorMap = new ColorMap();
		final int _A = colorMap.getId("#000000");
		final int _B = colorMap.getId("#ffffff");
		final var expected = new Theme(colorMap,
	...
	public void testRespectsIncomingDefaults4() {
		final var actual = createTheme(new ParsedThemeRule("", null, -1, FontStyle.NotSet, "#ff0000", null));
		final var colorMap = new ColorMap();
		final int _A = colorMap.getId("#ff0000");
		final int _B = colorMap.getId("#ffffff");
		final var expected = new Theme(colorMap, new ThemeTrieElementRule(0, null, FontStyle.None, _A, _B),
	...
	public void testRespectsIncomingDefaults5() {
		...
		final var expected = new Theme(colorMap, new ThemeTrieElementRule(0, null, FontStyle.Bold, _A, _B),
				NOTSET_THEME_TRIE_ELEMENT);
		assertEquals(actual, expected);
	}
	...
	public void testRulesAreInherited1() {
		...
		final var map1_1 = new HashMap<String, ThemeTrieElement>();
		map1_1.put("identifier", new ThemeTrieElement(new ThemeTrieElementRule(2, null, FontStyle.Bold, _D, NOT_SET)));
		final var map1 = new HashMap<String, ThemeTrieElement>();
	...
	public void testRulesAreInherited2() {
		...
		final var mapOfVar = new HashMap<String, ThemeTrieElement>();
		mapOfVar.put("identifier",
				new ThemeTrieElement(new ThemeTrieElementRule(2, null, FontStyle.Bold, _G, NOT_SET)));

		final var mapOfNumeric = new HashMap<String, ThemeTrieElement>();
		...
		final var mapOfConstant = new HashMap<String, ThemeTrieElement>();
		...
		final var mapRoot = new HashMap<String, ThemeTrieElement>();
