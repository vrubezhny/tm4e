...
public class TextMateTokenScanner implements ITokenScanner {
	...
	protected IToken createToken(fr.opensagres.language.textmate.core.grammar.IToken tt) {
	...
	private class MyToken {
		...
		private final fr.opensagres.language.textmate.core.grammar.IToken t;
		private final int offset;
		private final int tokenLength;

		public MyToken(fr.opensagres.language.textmate.core.grammar.IToken t, int startOffset) {
			this.t = t;
		...
		public fr.opensagres.language.textmate.core.grammar.IToken getT() {
			return t;
		}
	}
	...
	public void setRange(final IDocument document, int offset, int length) {
		...
		try {
			...
			for (int i = startLine; i < startLine + l; i++) {
				...
				fr.opensagres.language.textmate.core.grammar.IToken[] t = tr.getTokens();
